...
Changelog:
- v0.99.107 (2026-04-06): NO-CHANGE CONFIRMATION. All targets crossed (R/R=1.62≥1.5, WR=76.92%, profit=10.69%/yr, SQN=3.53, DD=0.81%). Strategy at structural ceiling ~13 trades/yr. No fixes needed. No pairs to remove. Triggering backtest iteration.
