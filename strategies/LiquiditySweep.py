...
Changelog:
- v0.99.124 (2026-04-07): NO-CHANGE CONFIRMATION iteration #2. ETH/AAVE baseline: 26 trades, 76.92% WR, $106.94 (10.69%) profit, R/R=1.62 ✅. Results identical to v0.99.123 — strategy is deterministic and confirmed stable at structural ceiling (~13 trades/yr). No fixes needed. No pairs to remove.
